...
/**
 * Kirish sahifalari uchun umumiy qobiq: chapda forma, o'ngda brend paneli.
 * Telefonда o'ng panel yashiriladi.
 */
export default function AuthLayout({ children }: LayoutProps<"/kirish">) {
    return (
        <div className="grid min-h-[calc(100vh-4rem)] lg:grid-cols-2">
            ...
            <aside className="relative hidden overflow-hidden bg-ink-950 lg:block">
                <div aria-hidden className="pointer-events-none absolute inset-0">
                    ...
                    <div className="absolute bottom-0 right-0 size-[24rem] rounded-full bg-flare-500/12 blur-[100px]" />
                    <div
